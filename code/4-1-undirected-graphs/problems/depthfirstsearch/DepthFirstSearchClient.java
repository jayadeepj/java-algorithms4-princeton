	...
	public static void main(String[] args) {
		...
		while (!StdIn.isEmpty()) {
			...
			else if(pressedKey.startsWith("!"))
			{
				...
				NonRecursiveDepthFirstSearch depthFirstSearch = new NonRecursiveDepthFirstSearch(graph, Integer.parseInt(source));
				System.out.println("Connected Nodes ==> "+depthFirstSearch.getConnectedNodes());
			}
			...
			else if(pressedKey.contains("#"))
			{
				...
				NonRecursiveDepthFirstSearch depthFirstSearch = new NonRecursiveDepthFirstSearch(graph, Integer.parseInt(sourceVertex));
				System.out.println("Path ==>  "+depthFirstSearch.findPath(Integer.parseInt(targetVertex)));
			}
